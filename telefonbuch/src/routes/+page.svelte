          ...
          <DataTable
            ...
            <svelte:fragment slot="cell" let:row let:cell>
              ...
              {:else if cell.key === "name"}
                <Link href="/person/{cell.value.id}">{cell.value.name}</Link>
              {:else if cell.key === "name"}
                <Link href="/person/{cell.value.id}">{cell.value.name}</Link>
              {/if}
            </svelte:fragment>
